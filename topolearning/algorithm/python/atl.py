...
This file contain the Adaptive Topological Learning (ATL) algorithm for topological learning. ATL
is a variant of SOINN and self-organising incremental neural network (ASOINN).
"""
import numpy as np
import numpy.matlib
...
def learning(input_data=None, max_nepoch=None, spread_factor=0.1, lamb=None):
    ...
    total_newnodes = 0
    n_newnodes = 0
    for ii in trange(2, sample_size, desc='\tATL Progress', leave=True):
